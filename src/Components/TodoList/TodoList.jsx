...
<Button onClick={() => {setIsModalOpen(true)}} className="flex justify-center md:justify-between text-nowrap items-center gap-2 md:gap-4 bg-blue-500 text-gray-200 " btnTask="Create New">
<Svg svgId="add" className="text-yellow-300" />
 ...
 {todos.length === 0 ? (
  ...
  <>
    {/* Todo list */}
    <div className="hidden sm:grid grid-cols-7 items-center justify-items-center gap-4 mb-1 pb-2 font-bold text-gray-500">
      <div className="text-sm md:text-base  col-span-3 justify-self-start pl-3">Title</div>
      <div className='text-xs md:text-base col-span-1 pr-3'>Importance</div>
      <div className="text-xs md:text-base col-span-1 pr-3">Edit</div>
      <div className="text-xs md:text-base col-span-1 pr-3">Completion</div>
      <div className="text-xs md:text-base col-span-1 md:pr-5 ">Delete</div>
    </div>
